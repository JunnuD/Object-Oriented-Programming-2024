...
class GameMuseum(GameWarehouse):
    ...
    def list_games(self):
        return [game for game in self._GameWarehouse__games if game.year < 1990] #The entire expression is enclosed in square brackets [], which signifies a list comprehension.
